...
cd seldonian/rl
/home/akanji/miniconda3/envs/seldnian-pre/bin/python run_hcga.py --workerid $SLURM_ARRAY_TASK_ID --num-training $SLURM_ARRAY_TASK_ID --out-dir output_swarm_strat_v2 --strat true 
cd ../..